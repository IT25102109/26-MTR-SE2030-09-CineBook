...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: 'Emily Watson submitted a 5★ review for Civil War. Action required in Review Moderation.',
    userId: '2',
    read: false,
  ...
  },
  {
    ...
    message: 'Your review for Dune: Part Two has been approved and is now live for all moviegoers!',
    userId: '1',
    read: false,
  ...
  },
  {
    ...
    message: 'Your 4★ review for Oppenheimer has been received and is awaiting staff moderation.',
    userId: '1',
    read: false,
